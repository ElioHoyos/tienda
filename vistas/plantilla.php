...
<head>
    ...
    echo '<link href="http://localhost/admin/'.$icono["icono"].'" rel="shortcut icon">';
    ...
    <!--====== Vendor Css ======-->
    <link rel="stylesheet" href="vistas/css/vendor.css">

    <!--====== Utility-Spacing ======-->
    <link rel="stylesheet" href="vistas/css/utility.css">
...
<body class="config">
    ...
    <div class="preloader is-active">
        <div class="preloader__wrap">
            ...
            <img class="preloader__img" src="vistas/images/preloader.png" alt=""></div>
    </div>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product2.jpg" alt=""></a>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product3.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product4.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product5.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product6.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product7.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product8.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product9.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                            ...
                                            <div class="product-o product-o--hover-on product-o--radius">
                                                <div class="product-o__wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product10.jpg" alt=""></a>
                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                ...
                                <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product11.jpg" alt=""></a>
                                ...
                                <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product12.jpg" alt=""></a>
                                        <div class="product-o__special-count-wrap">
                                            <div class="countdown countdown--style-special" data-countdown="2020/05/01"></div>
                                        </div>
                                        <div class="product-o__action-wrap">
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product13.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product14.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product15.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product16.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product17.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                    ...
                                    <div class="product-o product-o--hover-on">
                                        <div class="product-o__wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="vistas/images/product/electronic/product18.jpg" alt=""></a>
                                            <div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li>
                                ...
                                <div class="product-o product-o--hover-on u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product19.jpg" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product20.jpg" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product21.jpg" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on u-h-100">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/product/electronic/product22.jpg" alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product23.jpg" alt=""></a></div>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product24.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product25.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product26.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product27.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product28.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product29.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product30.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                                    <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.html">
                                                        ...
                                                        <img class="aspect__img" src="vistas/images/product/electronic/product31.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                                    <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                                ...
                                <div class="bp-mini bp-mini--img u-h-100">
                                    <div class="bp-mini__thumbnail">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/blog/post-2.jpg" alt=""></a>
                                        <!--====== End - Image Code ======-->
                                    </div>
                                ...
                                <div class="bp-mini bp-mini--img u-h-100">
                                    <div class="bp-mini__thumbnail">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/blog/post-12.jpg" alt=""></a>
                                        <!--====== End - Image Code ======-->
                                    </div>
                                    <div class="bp-mini__content">
                                        <div class="bp-mini__stat">
                                ...
                                <div class="bp-mini bp-mini--img u-h-100">
                                    <div class="bp-mini__thumbnail">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
                                            ...
                                            <img class="aspect__img" src="vistas/images/blog/post-5.jpg" alt=""></a>
                                        <!--====== End - Image Code ======-->
                                    </div>
                                    <div class="bp-mini__content">
                                        <div class="bp-mini__stat">
                            ...
                            <div class="owl-carousel" id="testimonial-slider">
                                <div class="testimonial">
                                    <div class="testimonial__img-wrap">
                                        ...
                                        <img class="testimonial__img" src="vistas/images/about/test-1.jpg" alt=""></div>
                                ...
                                <div class="testimonial">
                                    <div class="testimonial__img-wrap">
                                        ...
                                        <img class="testimonial__img" src="vistas/images/about/test-2.jpg" alt=""></div>
                                    <div class="testimonial__content-wrap">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial__img-wrap">
                                        ...
                                        <img class="testimonial__img" src="vistas/images/about/test-3.jpg" alt=""></div>
                                    <div class="testimonial__content-wrap">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial__img-wrap">
                                        ...
                                        <img class="testimonial__img" src="vistas/images/about/test-4.jpg" alt=""></div>
                                    <div class="testimonial__content-wrap">
                            ...
                            <div class="owl-carousel" id="brand-slider" data-item="5">
                                <div class="brand-slide">
                                    ...
                                    <a href="shop-side-version-2.html">
                                        ...
                                        <img src="vistas/images/brand/b1.png" alt=""></a></div>
                                <div class="brand-slide">

                                    <a href="shop-side-version-2.html">

                                        <img src="vistas/images/brand/b2.png" alt=""></a></div>
                                <div class="brand-slide">

                                    <a href="shop-side-version-2.html">

                                        <img src="vistas/images/brand/b3.png" alt=""></a></div>
                                <div class="brand-slide">

                                    <a href="shop-side-version-2.html">

                                        <img src="vistas/images/brand/b4.png" alt=""></a></div>
                                <div class="brand-slide">

                                    <a href="shop-side-version-2.html">

                                        <img src="vistas/images/brand/b5.png" alt=""></a></div>
                                <div class="brand-slide">

                                    <a href="shop-side-version-2.html">

                                        <img src="vistas/images/brand/b6.png" alt=""></a></div>
                            </div>
                        </div>
                        <!--====== End - Brand Slider ======-->
                    </div>
                            ...
                            <div class="outer-footer__content">
                                ...
                                <form class="newsletter">
                                    ...
                                    <div class="newsletter__group">
                                        ...
                                        <input class="input-text input-text--only-white" type="text" id="newsletter" placeholder="Suscribete con tu Correo Electronico">
                                    ...
                                    <div class="pd-wrap">
                                        <div id="js-product-detail-modal">
                                            <div>
                                                ...
                                                <img class="u-img-fluid" src="vistas/images/product/product-d-1.jpg" alt=""></div>
                                            <div>

                                                <img class="u-img-fluid" src="vistas/images/product/product-d-2.jpg" alt=""></div>
                                            <div>

                                                <img class="u-img-fluid" src="vistas/images/product/product-d-3.jpg" alt=""></div>
                                            <div>

                                                <img class="u-img-fluid" src="vistas/images/product/product-d-4.jpg" alt=""></div>
                                            <div>

                                                <img class="u-img-fluid" src="vistas/images/product/product-d-5.jpg" alt=""></div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="success u-s-m-b-30">
                                    ...
                                    <div class="success__img-wrap">
                                        ...
                                        <img class="u-img-fluid" src="vistas/images/product/electronic/product1.jpg" alt=""></div>
                        ...
                        <div class="row u-s-m-x-0">
                            <div class="col-lg-6 new-l__col-1 u-s-p-x-0">
                                ...
                                <a class="new-l__img-wrap u-d-block" href="shop-side-version-2.html">
                                    ...
                                    <img class="u-img-fluid u-d-block" src="vistas/images/newsletter/newsletter.jpg" alt=""></a></div>
                            <div class="col-lg-6 new-l__col-2">
                                <div class="new-l__section u-s-m-t-30">
                                    <div class="u-s-m-b-8 new-l--center">
                                        <h3 class="new-l__h3">Boletin Informativo</h3>
                                    </div>
                                    <div class="u-s-m-b-30 new-l--center">
                                        <p class="new-l__p1">Regístrese para recibir correos electrónicos para obtener información sobre los recién llegados, las ventas especiales y más.</p>
                                    </div>
                                    <form class="new-l__form">
                                        ...
                                        <div class="u-s-m-b-15">
                                            ...
                                            <button class="btn btn--e-brand-b-2" type="submit">¡Regístrate!</button></div>
                                    </form>
                                    <div class="u-s-m-b-15 new-l--center">
                                        <p class="new-l__p2">Al registrarse, acepta recibir ofertas de Reshop, <br /> promociones y otros mensajes comerciales. Puede darse de baja en cualquier momento.</p>
                                    </div>
                                    <div class="u-s-m-b-15 new-l--center">

                                        <a class="new-l__link" data-dismiss="modal">No Gracias</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!--====== Vendor Js ======-->
    <script src="vistas/js/vendor.js"></script>

    <!--====== jQuery Shopnav plugin ======-->
    <script src="vistas/js/jquery.shopnav.js"></script>
