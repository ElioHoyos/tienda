...
<head>
    ...
    <meta name="description" content="una tienda virtual">
    <meta name="author" content="Elio Hoyos">
    ...
    <!--====== Vendor Css ======-->
    <link rel="stylesheet" href="<?php echo $url; ?>vistas/css/vendor.css">

    <!--====== Utility-Spacing ======-->
    <link rel="stylesheet" href="<?php echo $url; ?>vistas/css/utility.css">
...
<body class="config">
    ...
    <div class="preloader is-active">
        <div class="preloader__wrap">
            ...
            <img class="preloader__img" src="<?php echo $url; ?>vistas/images/preloader.png" alt=""></div>
    </div>
    ...
    <!--====== Vendor Js ======-->
    <script src="<?php echo $url; ?>vistas/js/vendor.js"></script>

    <!--====== jQuery Shopnav plugin ======-->
    <script src="<?php echo $url; ?>vistas/js/jquery.shopnav.js"></script>
